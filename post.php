...
<div class="grid grid-cols-4">
    ...
    <div class="col-span-3">
        <div class="p-5">
            <h1 class="text-center text-3xl font-semibold"><?= $totalPosts ?> posts are available</h1>
        </div>
            ...
            foreach ($posts as $key => $p) : ?>
                <div class="bg-white p-5 h-fit mr-4 mb-4 shadow-lg hover:bg-blue-1 00 transition-all ">
                    ...
                    <div class="flex justify-center my-3">
                        <a class="px-7 text-white py-3 rounded-2xl bg-yellow-400 hover:bg-yellow-300 mr-5" href="./postedit.php?id=<?= $p['post_id'] ?>">Update</a>
                        <a class="px-7 text-white py-3 rounded-2xl bg-red-400 hover:bg-red-300 " href="./delete.php?tbname=posts&tbid=post_id&id=<?= $p['post_id'] ?>">Delete</a>
                    </div>
                </div>
            <?php endforeach ?>
        </div>
